...
const Index = () => {
  ...
  return (
    <Homepage>
      ...
      <section
        className={cn('container m-auto pt-[60px] md:pt-[80px] px-4 md:px-8 lg:px-[75px] relative')}
      >
        {/* Subtle background elements */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-orange-400/5 rounded-full blur-3xl animate-float"></div>
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-orange-400/5 rounded-full blur-3xl animate-float-delayed"></div>
        </div>
        
        <div className={cn('flex justify-center flex-col items-center')}>
          {/* Feature badge like seoitis */}
          <div className="animate-in fade-in slide-in-from-top-4 duration-500 mb-6">
            <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2 shadow-sm">
              <span className="flex items-center gap-1 text-sm font-semibold text-primary bg-orange-100 px-2.5 py-0.5 rounded-full">
                <span className="text-xs">⚡</span> 27+ Checks
              </span>
              <span className="text-sm text-gray-600">Web Performance Toolkit</span>
          ...
          <h1
            className={cn(
              'text-3xl md:text-4xl lg:text-[56px] font-extrabold w-full md:w-4/5 text-center mb-6 leading-tight tracking-tight',
              'animate-in fade-in slide-in-from-top-4 duration-700',
            )}
            style={{ fontFamily: "'Manrope', sans-serif" }}
          >
            <span className="block mb-1 text-foreground">
              Performance fixes{' '}
            </span>
            <span className="block">
              <span className="text-primary">you can</span>{' '}
              apply{' '}
              <span className="inline-block min-w-[140px] md:min-w-[180px] text-primary">
                {currentText}
          ...
          <div className="text-center w-full max-w-3xl">
            <p
              className={cn(
                'mb-8 text-base md:text-lg max-w-2xl mx-auto text-muted-foreground leading-relaxed',
                'animate-in fade-in slide-in-from-top-4 duration-700 delay-300',
              )}
            >
              Paste your URL and get a prioritized checklist of high-impact performance issues in seconds.{' '}
              <span className="font-semibold text-foreground">No bloated reports.</span>
            </p>
            ...
            >
              {/* SEOitis-style hero input group */}
              <div className="flex flex-col md:flex-row items-center gap-3 p-2 bg-white rounded-full border border-gray-200 shadow-hero-input focus-within:shadow-hero-input-focus focus-within:border-primary/30 transition-all">
                {/* Main URL Input */}
                      ...
                      <Field data-invalid={fieldState.invalid} className="w-full">
                        <div className="relative flex items-center">
                          ...
                          <Input
                            ...
                            className={cn(
                              'h-12 text-base pl-12 pr-4 bg-transparent border-0 shadow-none rounded-full',
                ...
                {/* Dropdowns - Hidden on mobile, shown on desktop */}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger
                          id="testType"
                          className="h-10 min-w-[140px] text-sm bg-gray-50 border-0 rounded-full hover:bg-gray-100 transition-colors"
                        >
                          <SelectValue placeholder="Quick Free Test" />
                        </SelectTrigger>
                        <SelectContent className="rounded-xl border shadow-lg">
                          <SelectGroup>
                            <SelectItem value="performance" className="rounded-lg">Performance Test</SelectItem>
                            <SelectItem value="security" className="rounded-lg">Security Test</SelectItem>
                            <SelectItem value="seo" className="rounded-lg">SEO Test</SelectItem>
                          </SelectGroup>
                        </SelectContent>
                      </Select>
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger
                          id="deviceType"
                          className="h-10 min-w-[120px] text-sm bg-gray-50 border-0 rounded-full hover:bg-gray-100 transition-colors"
                        >
                          <SelectValue placeholder="Desktop" />
                        </SelectTrigger>
                        <SelectContent className="rounded-xl border shadow-lg">
                          <SelectGroup>
                            <SelectItem value="desktop" className="rounded-lg">Desktop</SelectItem>
                            <SelectItem value="mobile" className="rounded-lg">Mobile</SelectItem>
                ...
                >
                  {isLoading ? 'Testing...' : 'Login to Scan'}
                </Button>
              </div>

              {/* Mobile dropdowns */}
              <div className="flex md:hidden items-center gap-2 mt-3 justify-center">
                <Controller
                  name="testType"
                  control={form.control}
                  render={({ field }) => (
                    <Select {...field} name="testType" onValueChange={field.onChange}>
                      <SelectTrigger className="h-10 text-sm bg-white border rounded-full">
                        <SelectValue placeholder="Quick Free Test" />
                      </SelectTrigger>
                ...
                <Controller
                  ...
                  control={form.control}
                  render={({ field }) => (
                    <Select {...field} name="deviceType" onValueChange={field.onChange}>
                      <SelectTrigger className="h-10 text-sm bg-white border rounded-full">
                        <SelectValue placeholder="Desktop" />
                      </SelectTrigger>
                      <SelectContent className="rounded-xl">
            ...
            {/* Feature badges below input - seoitis style */}
            <div className="flex flex-wrap justify-center gap-3 mb-8 animate-in fade-in duration-700 delay-700">
              <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                <svg className="w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>27+ Performance Checks</span>
              </div>
              <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                <svg className="w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            {/* Tool category chips - seoitis style */}
            <div className="flex flex-wrap justify-center gap-2 mb-10 animate-in fade-in duration-700 delay-[800ms]">
              <Link to="/dashboard/tests" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:border-primary hover:text-primary hover:bg-blue-50 transition-colors">
                <ChartLineIcon size={16} />
                Performance
              </Link>
              <Link to="/dashboard/batch" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:border-primary hover:text-primary hover:bg-blue-50 transition-colors">
                <NetworkIcon size={16} />
                Bulk Scan
              </Link>
              <Link to="/dashboard/analytics" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:border-primary hover:text-primary hover:bg-blue-50 transition-colors">
                <Settings size={16} />
                Analytics
              </Link>
              <Link to="/dashboard/scheduled" className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:border-primary hover:text-primary hover:bg-blue-50 transition-colors">
                <Shield size={16} />
                Scheduled
              </Link>
            </div>
      ...
      {/* What is BugSpy - Clean Card Section */}
      <section className="py-16 md:py-24 bg-white">
        <div className={cn('container m-auto px-4 md:px-8 lg:px-[75px]')}>
          <div className="text-center mb-12 md:mb-16">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-primary text-sm font-semibold rounded-full mb-4">
              About BugSpy
            </span>
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              BugSpy is a web-based platform that automates website testing to help developers, QA teams, and businesses deliver flawless digital experiences.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {/* Card 1 */}
            <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 hover:shadow-lg hover:border-primary/20 transition-all duration-300 group">
              <div className="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                <Settings size={28} className="text-primary group-hover:text-white transition-colors" />
              </div>
              <h3 className="font-bold text-lg md:text-xl text-foreground mb-3">
                Easy Automated Testing
              </h3>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Run instant or scheduled tests without complex setup. Just paste your URL and get comprehensive results in seconds.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 hover:shadow-lg hover:border-primary/20 transition-all duration-300 group">
              <div className="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                <ChartLineIcon size={28} className="text-primary group-hover:text-white transition-colors" />
              </div>
              <h3 className="font-bold text-lg md:text-xl text-foreground mb-3">
                Actionable Insights
              </h3>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Get categorized error reports, performance scores, and exportable data to make informed optimization decisions.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 hover:shadow-lg hover:border-primary/20 transition-all duration-300 group">
              <div className="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                <NetworkIcon size={28} className="text-primary group-hover:text-white transition-colors" />
              </div>
              <h3 className="font-bold text-lg md:text-xl text-foreground mb-3">
                Scalable for Teams
              </h3>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                From freelancers to enterprise QA teams, BugSpy grows with you. Collaborate, share reports, and maintain quality at scale.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Features Overview - Clean Card Section */}
      <section className="py-16 md:py-24 bg-muted/30">
        <div className={cn('container m-auto px-4 md:px-8 lg:px-[75px]')}>
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 tracking-tight capitalize">
              Features Overview
            </h2>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              Comprehensive tools to detect, analyze, and fix website performance issues
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Feature 1 */}
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Automatically categorize and prioritize errors by severity. Get detailed stack traces, affected components, and suggested fixes for each issue.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Capture full-page screenshots across different devices and viewports. Compare visual changes and detect UI regressions instantly.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300">
              <div className="aspect-video rounded-xl overflow-hidden mb-6 bg-gray-100">
                <img
                  ...
                  alt="Performance metrics feature"
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-3">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Track Core Web Vitals, load times, and resource usage. Get actionable recommendations to improve your website's speed and user experience.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                Set up automated tests that run on your schedule. Monitor your website's health 24/7 and get instant alerts when issues are detected.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 place-items-center mt-6 md:mt-8 lg:mt-10">
            <HowItWorksCard
              ...
              subTitle="Paste any URL you want to test."
